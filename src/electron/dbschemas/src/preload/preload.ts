...
import { IPC_EVENT_NEW_CONNECTION, IPC_EVENT_OPEN_FILE_PICKER, IPC_EVENT_REFRESH_CONNECTIONS, IPC_EVENT_TOGGLE_TABLE_COLUMN } from '../shared/domain/constants/IpcEventNames';
