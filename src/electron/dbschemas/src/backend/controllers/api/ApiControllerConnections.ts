...
import { OneWayMapper } from "../../../shared/mappers/basic-mappers/OneWayMapper";
import { ServiceResponseBaseHttpResponseMapper } from "../../../shared/mappers/basic-mappers/service-responses/ServiceResponseBaseHttpResponseMapper";
...
import { endpointArgsGetConnectionId } from "../../helpers/RouteParamsAccessor";
import { ControllerEndpointArgs } from "../../protocol/ControllerEndpointArgs";
import { diConnectionService } from "../../utilities/DependencyInjectionUtility";

/**
 * POST: /api/connections
 */
export async function apiConnectionsGetAll(args: ControllerEndpointArgs): Promise<Response>
{
 ...
 */
export async function apiConnectionsGet(args: ControllerEndpointArgs): Promise<Response>
{
    const connectionService = diConnectionService;
 ...
 * POST: /api/connections
 */
export async function apiConnectionsPost(args: ControllerEndpointArgs): Promise<Response>
{
    const connectionService = diConnectionService;
 ...
 */
export async function apiConnectionsPut(args: ControllerEndpointArgs): Promise<Response>
{
    const connectionService = diConnectionService;
    const requestData = await args.request.json() as ConnectionApiRequestForm;
    const connectionId = endpointArgsGetConnectionId(args);
 ...
 */
export async function apiConnectionsDelete(args: ControllerEndpointArgs): Promise<Response>
{
    const connectionService = diConnectionService;
    const connectionId = endpointArgsGetConnectionId(args);
